package bomberman.entity.character.enemy;
...
import bomberman.entity.character.enemy.ai.AI;
...
public abstract class Enemy extends Character {
	...
	public boolean canMove(double x, double y) {
		...
		int xx = Convert.pixelToTile(xr) +(int)x;
		int yy = Convert.pixelToTile(yr) +(int)y;
	...
	public void kill() {
		...
		Text msg = new Text("+" + _points, getXMessage(), getYMessage(), 2, Color.white, 14);
