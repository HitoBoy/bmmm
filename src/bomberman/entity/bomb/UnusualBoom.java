...
public class UnusualBoom extends Entity {

    protected Board _board;
    protected int _direction;
    private int _radius;
    protected int xOrigin, yOrigin;
    protected Boom[] _explosions;

    public UnusualBoom(int x, int y, int direction, int radius, Board board) {
        xOrigin = x;
        yOrigin = y;
        _x = x;
        _y = y;
        ...
        _explosions = new Boom[ calculatePermitedDistance() ];
        createExplosions();
    }
    ...
    private void createExplosions() {
        ...
        for (int i = 0; i < _explosions.length; i++) {
            ...
            _explosions[i] = new Boom(x, y, _direction, last, _board);
        }
    }
