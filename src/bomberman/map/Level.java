...
public abstract class Level implements Leveling {
    ...
    protected static String[] codes = {
            "You pathetically failed the first level",
            "cuq0vaxstb",
            "38y418wriq",
            "34h8k0chcs",
            "9qztxh6l4s",
    ...
    public Level(String path, Board board) throws LevelEx{
        loadLevel(path);
        _board = board;
    }

    @Override
    public abstract void loadLevel(String path) throws LevelEx;
