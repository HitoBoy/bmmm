...
public class Screen {
    ...
    public static int calculateXOffset(Board board, Player player) {
        ...
        if( playerX > firstBreakpoint + complement && playerX < lastBreakpoint - complement) {
            temp = (int)player.getX()  - (GameLoop.WIDTH / 2);
        }
    ...
    public void drawEndGame(Graphics g, int points, String code) {
        ...
        drawCenteredString(code, getRealWidth(), getRealHeight() * 2  - (GameLoop.TILES_SIZE * 2) * GameLoop.SCALE, g);
    }
    ...
    public int getRealWidth() {
        return _width * GameLoop.SCALE;
    }

    public int getRealHeight() {
        return _height * GameLoop.SCALE;
    }
}
